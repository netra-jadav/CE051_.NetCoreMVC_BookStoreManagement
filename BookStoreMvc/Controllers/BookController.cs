...
namespace BookStoreMvc.Controllers
{
    ...
    public class BookController : Controller
    {
        ...
        public BookController(IBookService bookService, IFileService fileService, IGenreService genService)
        {
        ...
        public IActionResult Edit(int id)
        {
            ...
            var selectGenres = _bookService.GetGenreByBookId(model.Id);
